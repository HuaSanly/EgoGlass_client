...
from operator_console.desktop import LocalConsoleServer, build_desktop_url
    ...
    for iteration in range(3):
        ...
        try:
            ...
            with opener.open(f"{server.origin}/assets/app.js", timeout=5) as response:
                ...
                assert b"/api/v1/webrtc/decoded-preview.mjpg" in script
                assert b"/api/v1/webrtc/decoded-preview/status" in script
                assert b"RTCPeerConnection" not in script
