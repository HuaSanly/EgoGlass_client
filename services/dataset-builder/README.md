...
| Path | Purpose |
| --- | --- |
| `src/egoglass_dataset_builder/` | Python package for dataset assembly. |
| `tests/` | Fast deterministic schema, split, and reproducibility tests. |
| `evals/` | Periodic coverage, lineage, and training-readiness evaluations. |
| `config/` | Versioned sample, split, and export configuration. |
